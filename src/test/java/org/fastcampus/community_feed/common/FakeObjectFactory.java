...
import org.fastcampus.community_feed.post.repository.FakeMessageRepository;
...
public class FakeObjectFactory {
    ...
    private static final MessageRepository fakeFcmPushRepository = new FakeMessageRepository();
    ...
    private static final PostService postService = new PostService(userService, fakePostRepository, fakeLikeRepository, fakeFcmPushRepository);
